...
describe('Mechanic Management Delete Component', () => {
  let comp: MechanicDeleteDialogComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [MechanicDeleteDialogComponent],
      providers: [NgbActiveModal],
    })
      .overrideTemplate(MechanicDeleteDialogComponent, '')
      .compileComponents();
