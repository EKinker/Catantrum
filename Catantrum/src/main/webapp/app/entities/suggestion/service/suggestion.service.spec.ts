...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../suggestion.test-samples';

import { SuggestionService } from './suggestion.service';

const requireRestSample: ISuggestion = {
